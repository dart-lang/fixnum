...
void main() {
  ...
  group('arithmetic operators', () {
    ...
    var n3 = Int64(-1234);
    var n4 = Int64(-9876);
    var n5 = Int64.fromInts(0x12345678, 0xabcdabcd);
    var n6 = Int64.fromInts(0x77773333, 0x22224444);
    ...
    test('~/', () {
      var deadBeef = Int64.fromInts(0xDEADBEEF, 0xDEADBEEF);
      var ten = Int64(10);
  ...
  group('comparison operators', () {
    var largeNeg = Int64.fromInts(0x82341234, 0x0);
    var largePos = Int64.fromInts(0x12341234, 0x0);
    var largePosPlusOne = largePos + Int64(1);
  ...
  group('bitwise operators', () {
    ...
    var n2 = Int64(9876);
    var n3 = Int64(-1234);
    var n4 = Int64(0x1234) << 32;
    var n5 = Int64(0x9876) << 32;
  ...
  test('JavaScript 53-bit integer boundary', () {
    ...
    var fact18 = _factorial(Int64(18));
    var fact17 = _factorial(Int64(17));
  ...
  group('string representation', () {
    test('toString', () {
      ...
      var top = 922337201;
      var bottom = 967490662;
      var fullnum = (Int64(1000000000) * Int64(top)) + Int64(bottom);
    ...
    test('toHexString', () {
      var deadbeef12341234 = Int64.fromInts(0xDEADBEEF, 0x12341234);
    ...
    test('toStringUnsigned', () {
      ...
      for (var value in values) {
        for (var radix = 2; radix <= 36; radix++) {
          var s1 = value.toRadixStringUnsigned(radix);
          var v2 = Int64.parseRadix(s1, radix);
          expect(v2, value);
          var s2 = v2.toRadixStringUnsigned(radix);
          expect(s2, s1);
        }
        var s3 = value.toStringUnsigned();
        var v4 = Int64.parseInt(s3);
        expect(v4, value);
        var s4 = v4.toStringUnsigned();
        expect(s4, s3);
      }
    });
  });
